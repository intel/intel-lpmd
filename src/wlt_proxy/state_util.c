/*
 * state_util.c: Intel Linux Energy Optimier proxy detection utilities/functions
 *
 ...
 *
 * This file contains the procy workload type detection utilities/functions/Calculations.
 */
#define _GNU_SOURCE
